...
void OnSurfaceCreatedCB(OH_NativeXComponent *component, void *window) {
    ...
    if (listener) {
        listener->onSurfaceCreated(component, static_cast<NativeWindow *>(window));
    }
}
...
bool XComponentHandler::AddListener(const std::string &xComponentID, std::weak_ptr<XComponentListener> listener) {
