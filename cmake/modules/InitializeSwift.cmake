  ...
  if(NOT SWIFT_LIBRARY_SEARCH_PATHS)
    ...
    if(APPLE)
      if(CMAKE_OSX_SYSROOT)
        list(APPEND SDK_FLAGS "-sdk" "${CMAKE_OSX_SYSROOT}")
      endif()
      
      # Set target triple for Apple platforms
      if(APPLE_TARGET_TRIPLE)
        list(APPEND TARGET_FLAGS "-target" "${APPLE_TARGET_TRIPLE}")
      endif()
    endif()

    # Pass target triple to get correct library paths for cross-compilation
    execute_process(
      COMMAND ${CMAKE_Swift_COMPILER} ${SDK_FLAGS} ${TARGET_FLAGS} -print-target-info
